...
for NAME in audio etc etc/acdbdata/MTP etc/acdbdata/QRD etc/firmware egl hw nfc etc/firmware/wlan
do
...
COMMON_FIRMWARE_WLAN="
	WCNSS_cfg.dat
        "
copy_files "$COMMON_FIRMWARE_WLAN" "system/etc/firmware/wlan/prima" "etc/firmware/wlan"
